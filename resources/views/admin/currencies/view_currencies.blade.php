            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <a href="{{ url('/admin-panel/edit-currency/'.$currency->id) }}" class="btn btn-info btn-mini">Edit</a> 
                    <a href="{{ url('/admin-panel/delete-currency/'.$currency->id) }}" class="btn btn-danger btn-mini">Delete</a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
