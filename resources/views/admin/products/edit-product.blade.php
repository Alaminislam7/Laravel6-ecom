        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ URL::to('admin-panel/edit-product/'.$productDetails->id) }}" name="edit_product" id="edit_product" novalidate="novalidate">
                    {{csrf_field()}}
                  <div class="control-group">
                    <label class="control-label">Under Category</label>
                    <div class="controls">
                      <select name="category_id" style="width:220px" id="category_id">
                        <?php echo $category_drowdown ?? ''; ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    <label class="control-label">Meteriul & Care</label>
                    <div class="controls">
                      ...
                      <div id="uniform-undefined">
                        <table>
                          <tr>
                            ...
                            <td>
                              @if(!empty($productDetails->image))
                                <img style="width:30px;" src="{{ asset('/images/backend_images/products/small/'.$productDetails->image) }}"> | <a href="{{ url('/admin-panel/delete-product-image/'.$productDetails->id) }}">Delete</a>
                              @endif
                            </td>
                          </tr>
                        </table>
                    ...
                    <div class="controls">
                      <div id="uniform-undefined">
                        ...
                        @if(!empty($productDetails->video))
                          ...
                          <a href="{{ url('/admin-panel/delete-product-video/'.$productDetails->id) }}">Delete</a>
                        @endif
                      </div>
                    </div>
                  </div>
