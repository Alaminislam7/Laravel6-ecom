        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin-panel/edit-banner/'.$bannerDetails->id) }}" name="edit_banner" id="edit_banner" novalidate="novalidate">{{ csrf_field() }}
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="url" name="link" id="link" value="{{ $bannerDetails->link }}">
                    </div>
                  </div>
                  <div class="control-group">
