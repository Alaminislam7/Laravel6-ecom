...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            ...
            <h2>Invoice</h2><h3 class="pull-right"># {{ $orderDetails->id }}</h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
    					...
    					<table class="table table-condensed">
    						<thead>
                                <tr>
        							...
        							<td style="width:15%" class="text-center"><strong>Name</strong></td>
        							<td style="width:15%" class="text-center"><strong>Size</strong></td>
        							<td style="width:15%" class="text-center"><strong>Color</strong></td>
        							<td style="width:15%" class="text-left"><strong>Price</strong></td>
        							<td style="width:15%" class="text-left"><strong>Quantity</strong></td>
        							<td style="width:20%" class="text-right"><strong>Total</strong></td>
                                </tr>
    						</thead>
    						<tbody>
                                ...
                                @foreach($orderDetails->orders as $pro)
                                    <tr>
                                        ...
                                        <td class="text-left">{{ $pro->product_price }}</td>
    							...
    							<tr>
    								...
    								<td class="no-line text-right">TK {{ $orderDetails->shipping_charges }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
