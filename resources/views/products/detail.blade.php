                    ...
                    <div class="col-sm-5">
                        <div class="view-product">
                            ...
                            <a id="mainImgLarge" href="{{ asset('/images/backend_images/products/large/'.$productDetails->image) }}">
                                <img style="width:300px" id="MainImage" src="{{ asset('/images/backend_images/products/medium/'.$productDetails->image) }}" alt="" />
                            </a>
                            </div>
                        </div>
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                @if(count($productAltimage)>0)
                                <div class="item active thumbnails">
                                    @foreach($productAltimage as $altimg)
                                ...
                                <span>
                                    ...
                                    <span id="getPrice">
                                        ...
                                        <h2>
                                            ...
                                            GBP {{ $getCurrencyRates['GBR_Rate'] }}<br>
