...
<section id="do_action">
    <div class="container">
        <div class="heading" align="center">
            <h3>YOUR <strong><i class="fa fa-cc-paypal" aria-hidden="true"></i></strong>ORDER HAS BEEN PLACED</h3>
            <p>Your order number is {{Session::get('order_id')}} and total payable is TK {{Session::get('grand_total')}}</p>
